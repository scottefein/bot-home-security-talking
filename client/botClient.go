...
func (botclient *BotClient) Authenticate() int {
...
func (botClient BotClient) SendMessage(streamId string, message string, format string) {
...
func (botClient BotClient) SendPlainTextMessage(streamId string, message string) {
	botClient.SendMessage(streamId, message, "TEXT")
}

func (botClient BotClient) SendMessageMLMessage(streamId string, message string) {
